...
for	( ib = 0; ib < glo->panneau2.bandes.size(); ++ib )
	{
	for	( ic = 0; ic < glo->panneau2.bandes[ib]->courbes.size(); ++ic )
		delete glo->panneau2.bandes[ib]->courbes[ic];
	delete glo->panneau2.bandes[ib];
	}
glo->panneau2.bandes.clear();
glo->panneau2.dump();
printf("panneau2 : layers and strips deleted\n");
