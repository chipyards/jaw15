...
DEMO5/demo5 -Z 32 -P 1.203 -w 11 -B 10.083 -i 200 -4
DEMO5/demo5 -Z 32 -P 1.203 -w 11 -B 10.083 -i 10000 -4
...
# i.e. on prend "1 pour 1" echantillon de la table de Castro mais possiblement decale 
DEMO5/demo5 -Z 32 -P 153.9375 -w 6 -4
DEMO5/demo5 -Z 32 -P 153.9375 -w 6 -4 -A 0.5
DEMO5/demo5 -Z 32 -P 153.9375 -w 11 -B 10.083
DEMO5/demo5 -Z 32 -P 153.9375 -w 11 -B 10.083 -A 0.5
...
DEMO5/demo5 -Z 32 -r 44100 -f 2000 -g 4000 -w 5 -o DEMO5/filt-2000-4000.wav DEMO5/lin22k.wav
# WAV resample
...
DEMO5/demo5 -Z 8 -P 1.3 -w 5 -6 -c 3 -K 1.01 -o DEMO5/dirac101_lanc8.png DEMO5/dirac.png
