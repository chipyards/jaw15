...
SOURCESCPP= layers.cpp gluplot.cpp jluplot.cpp spectro.cpp process.cpp gui.cpp
HEADERS= glostru.h  gluplot.h jluplot.h layers.h modpop2.h pa_devs.h process.h spectro.h wav_head.h
...
-lpangocairo-1.0 \
-lpangowin32-1.0 \
-L$(FFTWBASE) -lfftw3f-3 \
# -LF:\Appli\portaudio\lib\.libs -lportaudio \
# -mwindows
